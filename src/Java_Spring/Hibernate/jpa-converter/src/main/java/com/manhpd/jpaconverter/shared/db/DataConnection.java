...
import com.manhpd.jpaconverter.shared.exception.TargetNotFoundException;
...
public class DataConnection extends Connection implements Serializable {
    ...
    public <T> void updateWithCheck(T entity, Object primaryKey) throws TargetNotFoundException {
    ...
    public <T> void removeWithCheck(Class<T> entityClass, Object primaryKey) throws TargetNotFoundException {
    ...
    private <T> void checkIfExists(Class<T> entityClass, Object primaryKey) throws TargetNotFoundException {
