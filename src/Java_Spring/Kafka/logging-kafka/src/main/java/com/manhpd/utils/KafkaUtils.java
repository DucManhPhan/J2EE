...
public class KafkaUtils {
    ...
    public static void displayKafkaMessage(ConsumerRecords<String, String> records) {
        for (ConsumerRecord record : records) {
            logger.info(String.format("Topic - %s, Partition - %d, Value: %s", ((ConsumerRecord) record).topic(), ((ConsumerRecord) record).partition(), ((ConsumerRecord) record).value()));
        }
    }
}
